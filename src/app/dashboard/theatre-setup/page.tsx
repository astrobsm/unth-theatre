...
import ReadinessPanel from '@/components/theatre/ReadinessPanel';
...
export default function TheatreSetupPage() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(fetchSetups, 30 * 60 * 1000);
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Readiness, at the top, and no longer behind a stores document.
          It used to live on the material-collection record, so a nurse in a
          fully prepared theatre was told "No material collection recorded for
          today yet" — which sounds like a statement about the theatre and is
          actually one about paperwork for the trolley. Collection is still
          below; it is simply no longer in the way. */}
      <ReadinessPanel />
